...
trait Solver extends GameDef {
   ...
   */
  def done(b: Block): Boolean = b.isLegal && b.isStanding && b.b1 == goal
   ...
   */
  lazy val pathsToGoal: Stream[(Block, List[Move])] = pathsFromStart filter (Block(goal, goal) == _._1)
